...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('myworld_bringup_sim')
    ...
    return LaunchDescription([
        ...
        # 碰撞监视模块已注释，不启动 collision_monitor、生命周期管理器和边界可视化。
